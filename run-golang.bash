...
java -jar modules/openapi-generator-cli/target/openapi-generator-cli.jar generate --git-repo-id namsor-golang-sdk2 --git-user-id namsor --artifact-version 2.0.11 --group-id com.namsor --artifact-id namsor-sdk2 -i https://v2.namsor.com/NamSorAPIv2/api2/openapi.json -g go -o  namsor/client/go
cd ./namsor/client/go/
